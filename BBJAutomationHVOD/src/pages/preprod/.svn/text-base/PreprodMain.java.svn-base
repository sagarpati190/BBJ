...
public class PreprodMain extends Utility {
	WebDriver driver;
	...
	By linkAddtoSchedule = By.partialLinkText("Add to Schedule");
	By linkSchedulePage = By.partialLinkText("Schedule Page");
	...
	public PreprodMain(WebDriver driver){
		this.driver = driver;
	}
